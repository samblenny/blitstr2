...
function initialize() {
    // Initialize LCD screen including anti-blur fix for non-integer dpi-ratio screens
    screen.height = 536;
    screen.width = 336;
    screen.style.height = (536 / pixelRatio) + 'px';
    screen.style.width = (336 / pixelRatio) + 'px';
    wasm.init();
    repaint();
}
